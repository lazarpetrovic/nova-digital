    ...
    return (
        <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            className="absolute inset-0 flex flex-col items-center justify-center sm:px-6">
                ...
                <div className="container mx-auto flex flex-col items-center justify-center gap-10 max-w-4xl pt-15">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white text-center">We Build Digital{' '}<br/>
                        <span className="bg-gradient-to-r from-[#4f46e5] to-[#4F46E5]/70 bg-clip-text text-transparent">Experiences<br/></span>
                        {' '}That Convert
                    </h1>
                    <p className="text-base md:text-xl text-white/70 max-w-2xl text-center leading-relaxed">              
                    ...
                    <div className="flex flex-col sm:flex-row gap-6">
                        <a href="#contact" className="text-center px-8 py-3 bg-gradient-to-br from-[#4f46e5] to-purple-600 text-white rounded-xl font-medium transition-all duration-300 hover:shadow-lg hover:shadow-purple-600/30 hover:scale-103 transition-shadow transition-transform duration-300">
                            Get Started
                        </a>
                        <a href="#portfolio" className="text-center px-8 py-3 text-white font-medium border border-white/10 rounded-xl bg-white/5 backdrop-blur-xl hover:bg-white/20 hover:border-white/20 transition-all duration-300">
                            Portfolio
                        </a>
                    </div>
                </div>
            ...
            <div className="absolute -bottom-10 left-0 w-full h-40 bg-gradient-to-b from-transparent to-black pointer-events-none" aria-hidden />
